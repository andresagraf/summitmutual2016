...
// Register Custom Post Type
function custom_post_type_auspiciadores() {

	$labels = array(
		'name'                  => _x( 'Auspiciadores', 'Post Type General Name', 'text_domain' ),
		'singular_name'         => _x( 'Auspiciadores', 'Post Type Singular Name', 'text_domain' ),
		'menu_name'             => __( 'Auspiciadores', 'text_domain' ),
		'name_admin_bar'        => __( 'Auspiciadores', 'text_domain' ),
		'parent_item_colon'     => __( 'Parent Item:', 'text_domain' ),
		'all_items'             => __( 'Todas los Auspiciadores', 'text_domain' ),
		'add_new_item'          => __( 'Añadir nuevo Auspicio', 'text_domain' ),
		'add_new'               => __( 'Añadir nuevo', 'text_domain' ),
		'new_item'              => __( 'Nuevo Item', 'text_domain' ),
		'edit_item'             => __( 'Editar Item', 'text_domain' ),
		'update_item'           => __( 'Update Item', 'text_domain' ),
	...
	$args = array(
		'label'                 => __( 'Auspiciadores', 'text_domain' ),
		'description'           => __( 'Auspiciadores Summit', 'text_domain' ),
		'labels'                => $labels,
	...
	register_post_type( 'auspiciadores', $args );

}
add_action( 'init', 'custom_post_type_auspiciadores', 0 );
